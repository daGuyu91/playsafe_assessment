...
public class Roulette implements GameResultsListener {
    ...
    public static void main(String[] args) {
        try {
            ...
            Roulette roulette = new Roulette(args);
            roulette.start();
            roulette.stop();
    ...
    public Roulette(final GameRepository args) {
        game = tryLoadingGameUsing(firstElementFrom(args));
        game.addListener(this);
    }

    private void addListener(Roulette roulette) {
    }
     ...
     * @return
     */
    private Roulette tryLoadingGameUsing(final String initFilePath) {
     ...
     */
    private Roulette loadGameFrom(final File file) throws GameException {
